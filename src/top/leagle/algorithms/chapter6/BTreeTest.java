...
public class BTreeTest {
	public static void main(String[] args) {
		BTree<Character, String> bTree = new BTree<>();
		bTree.put('K', "Kill");
		bTree.put('D', "Dad");
		bTree.put('H', "Head");
		bTree.put('Q', "Queue");
		...
		bTree.put('N', "Nice");
		bTree.put('O', "Operate");
		bTree.put('P', "Producure");
		bTree.put('R', "Run");
		bTree.put('T', "Terminal");
		bTree.put('W', "When");
		bTree.put('X', "Xy");
		bTree.put('A', "Allen");
	}
...
class BTree<Key extends Comparable<Key>, Value> {
	...
	private static final class Node {
		...
		public String toString() {
			return "Node [m=" + m + ", children=" + Arrays.toString(children) + "]";
		}
	...
	private static class Entry {
		...
		@Override
		public String toString() {
			return "Entry [key=" + key + ", val=" + val + ", next=" + next + "]";
		}
