package top.leagle.algorithms.chapter6;
 ...
 * Dependencies: FlowNetwork.java FlowEdge.java Queue.java Data files:
 * https://algs4.cs.princeton.edu/65maxflow/tinyFN.txt
 *
 * Ford-Fulkerson algorithm for computing a max flow and a min cut using
 * shortest augmenting path rule.
 *
 ******************************************************************************/
...
class FordFulkerson {
	...
	/**
	 * Compute a maximum flow and minimum cut in the network {@code G} from vertex
	 * {@code s} to vertex {@code t}.
	 *
	 * @param G
	 *            the flow network
	 * @param s
	...
	public static void main(String[] args) {
		...
		int E = 8;
		int s = 0, t = V - 1;
		FlowNetwork G = new FlowNetwork(new In("E:\\open source\\algs4\\algs4-data\\tinyFN.txt"));
		StdOut.println(G);
